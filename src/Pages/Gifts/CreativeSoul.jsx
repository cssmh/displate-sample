    ...
    <div>
      <div className="flex flex-col lg:flex-row items-center justify-between py-6">
        <div className="w-full lg:w-[30%] px-6 lg:px-10 space-y-3">
          ...
          <h1 className="text-4xl md:text-5xl font-medium">Creative</h1>
          <h1 className="text-4xl md:text-5xl font-medium">Soul</h1>
          <div className="mt-6">
            <Link
              to="/posters?category=community-choice"
