...
const WhatIsDisplate = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-between bg-gray-100 p-8 rounded-lg shadow-lg space-y-8 md:space-y-0">
      <div className="w-full md:w-[40%] text-center p-6 shadow-lg md:text-left">
        ...
        <p className="text-base text-gray-600 leading-relaxed">
          ...
          <span className="font-semibold">unique passions.</span> We’ve created
          a 21st-century canvas that’s sturdy, magnet mounted, and durable
          enough to withstand a lifetime of intense staring.
        </p>
        <p className="text-base text-gray-600 leading-relaxed mt-4">
          ...
          <span className="font-semibold">20 seconds to set them up</span> with
          no power tools, no damages, no frustrations.
        </p>
        <p className="text-base text-gray-600 leading-relaxed mt-4">
          Now go ahead and search for your next roommate among our{" "}
          <span className="font-semibold">unique and licensed artworks!</span>
        </p>
      </div>
